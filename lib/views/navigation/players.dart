...
class _PlayersState extends State<Players>{
  ...
  void initState() {
    ...
    fetchPlayersData().then((_) {
      followProvidersMatrix = List.generate((playersData!.length), (columnIndex) {
  ...
  Future<void> fetchPlayersData() async {
    ...
    if (username.isNotEmpty) {
      try {
        final response = await http.get(Uri.parse('https://takwira.me/api/players?username=$username'));
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Ink(child: ProfileCard(gameDataS : playerDatas)),
                                          ),
                                        ),
                                        Positioned(
                                          top: width(169.5),
